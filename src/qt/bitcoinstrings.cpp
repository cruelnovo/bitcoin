...
"is unlikely that any Vertcoin Core peers connect to it. See doc/p2p-bad-ports."
...
QT_TRANSLATE_NOOP("vertcoin-core", "Cannot set -forcednsseed to true when setting -dnsseed to false."),
...
QT_TRANSLATE_NOOP("vertcoin-core", "Input not found or already spent"),
...
QT_TRANSLATE_NOOP("vertcoin-core", "Missing amount"),
QT_TRANSLATE_NOOP("vertcoin-core", "Missing solving data for estimating transaction size"),
QT_TRANSLATE_NOOP("vertcoin-core", "Need to specify a port with -whitebind: '%s'"),
QT_TRANSLATE_NOOP("vertcoin-core", "No addresses available"),
...
QT_TRANSLATE_NOOP("vertcoin-core", "Transaction change output index out of range"),
...
QT_TRANSLATE_NOOP("vertcoin-core", "Transaction needs a change address, but we can't generate it."),
...
QT_TRANSLATE_NOOP("vertcoin-core", "Unable to parse -maxuploadtarget: '%s'"),
