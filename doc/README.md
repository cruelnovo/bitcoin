...
Development
---------------------
The Vertcoin repo's [root README](/README.md) contains relevant information on the development process and automated testing.
...
- [vertcoin.conf Configuration File](bitcoin-conf.md)
